...
def create_maxitrain_minival(train_file, val_file, output_dir):
    ...
    """
    maxitrain_path = os.path.join(output_dir, "instances_maxitrain.json")
    minival_path = os.path.join(output_dir, "instances_minival.json")
...
if __name__ == "__main__":
    parser = ArgumentParser(
        description="Script that takes the 2014/2017 training and validation annotations and"
