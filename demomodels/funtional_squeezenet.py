# can be reduced to ~1.3MB
# found an implementation below that goes down to 0.5KB
# accurate enough to be used by a ton of iOS apps
...
def SqueezeNet(nb_classes, inputs=(3, 224, 224)):
    ...
    maxpool4 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), name="maxpool4", data_format="channels_first"
    )(merge4)
    ...
    maxpool8 = MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), name="maxpool8", data_format="channels_first"
    )(merge8)
...
open("/tmp/squeezenet.tflite", "wb").write(tflite_model)
